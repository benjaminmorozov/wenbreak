...
Rules_OnPluginStart()
{
	...
	gH_Cvar_Rules_Mode = CreateConVar("sm_hosties_rules_mode", "2", "1 - Panel Mode, 2 - Website", FCVAR_NONE, true, 1.0, true, 2.0);
	gShadow_Rules_Mode = 2;
	
	gH_Cvar_Rules_Website = CreateConVar("sm_hosties_rules_website", "http://wenbreak.ga/forum/topic/3-pravidla-jailbreak", "The website for the rules page.", FCVAR_NONE);
	Format(gShadow_Rules_Website, sizeof(gShadow_Rules_Website), "http://wenbreak.ga/forum/topic/3-pravidla-jailbreak");
